          ...
          {isSent ? (
            <div className="flex flex-col items-center space-y-6 py-4">
              ...
              <p className="text-sm text-muted-foreground text-center leading-relaxed">
                Если аккаунт с адресом <strong className="text-foreground">{email}</strong> существует, 
                вы получите письмо со ссылкой для сброса пароля. Ссылка действительна 20 минут.
              </p>
            </div>
          ) : (
