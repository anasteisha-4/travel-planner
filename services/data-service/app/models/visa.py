...
class VisaRule(Base):
    ...
    visa_type: Mapped[VisaType] = mapped_column(Enum(VisaType, name="visatype"), nullable=False)
    ...
    __table_args__ = (
        UniqueConstraint("citizenship_code", "destination_id", name="uq_visa_citizenship_dest"),
