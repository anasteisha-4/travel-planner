...
class DestinationConnectivity(Base):
    ...
    direct_from_moscow: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    direct_from_spb: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    direct_from_ekb: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    direct_from_novosibirsk: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    # Transit hubs (post-2022 relevant for Russian travelers)
    transit_via_dubai: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    transit_via_istanbul: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    transit_via_yerevan: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    transit_via_tashkent: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    transit_via_tbilisi: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    # Ground transport
    train_from_moscow: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    ...
    connectivity_score: Mapped[float] = mapped_column(
        Float, nullable=False, server_default="0.0"
    )
    # Payment
    mir_card_accepted: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    # Metadata
