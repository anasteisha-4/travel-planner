...
class DestinationLanguageAccessibility(Base):
    ...
    local_languages: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
    ...
    has_cyrillic_signs: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    # easy (Latin/Cyrillic) | moderate (Arabic/Greek/Hebrew/Devanagari) | hard (CJK/Thai/Khmer)
    script_difficulty: Mapped[str] = mapped_column(String(20), nullable=False, server_default="easy")
    # rule_based | manual
