...
class DestinationAttributes(Base):
    ...
    has_ski: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    has_thermal: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    is_coastal: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    ...
    data_source: Mapped[str] = mapped_column(
        String(50), nullable=False, server_default="osm_inferred"
    )
